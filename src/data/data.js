...
// Helper function to keep our structure clean
// Pass an object for categories, or null for calculators. You can also pass a custom image.
...
export const appData = {
  "Chain Link": createNode(), // null children means it's a calculator
  "Expanded Metal": createNode(),
  "Hexagonal Wiremesh": createNode(),
  "Perforated Sheet": createNode({
    "Open Area (%) Calculation": createNode(perforatedHoleTypes),
