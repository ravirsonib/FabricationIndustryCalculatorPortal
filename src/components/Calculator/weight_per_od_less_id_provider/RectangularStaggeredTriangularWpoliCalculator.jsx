...
export default function RectangularStaggeredTriangularWpoliCalculator({ title, image }) {
  ...
  return (
    <CalculatorView title={title} image={image} description="Calculate weight per OD (Less ID) for Rectangular Staggered Triangular holes.">
