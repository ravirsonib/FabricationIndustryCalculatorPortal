...
export default function SquareCenterToCenterWpoliCalculator({ title, image }) {
  ...
  return (
    <CalculatorView title={title} image={image} description="Calculate weight per OD (Less ID) for Square Center to Center holes.">
