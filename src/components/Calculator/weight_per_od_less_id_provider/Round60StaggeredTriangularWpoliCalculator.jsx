...
export default function Round60StaggeredTriangularWpoliCalculator({ title, image }) {
  ...
  return (
    <CalculatorView title={title} image={image} description="Calculate weight per OD (Less ID) for Round 60° Staggered holes.">
