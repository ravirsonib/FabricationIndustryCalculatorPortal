...
export default function Round90CenterToCenterWpoliCalculator({ title, image }) {
  ...
  }, [materialId, holeDiameter, widthPitch, lengthPitch, thickness, outerDiameter, perfDiameter, innerDiameter, cost, holeDiameterUnit, widthPitchUnit, lengthPitchUnit, thickUnit, odUnit, pdUnit, idUnit]);

  const handleClear = () => { /* Clear all */ };

  return (
    <CalculatorView title={title} image={image} description="Calculate weight per OD (Less ID) for Round 90° Center to Center holes.">
