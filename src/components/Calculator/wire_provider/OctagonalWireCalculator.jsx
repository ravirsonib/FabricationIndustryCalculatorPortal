...
export default function OctagonalWireCalculator({ title, image }) {
  ...
  useEffect(() => {
    ...
    if (tM > 0 && lM > 0) {
      ...
      const area = 0.82842712474 * (tM * tM);
  ...
  return (
    <CalculatorView title={title} image={image} description="Calculate weight for Octagonal Wire.">
