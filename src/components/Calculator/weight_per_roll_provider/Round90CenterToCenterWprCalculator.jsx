...
export default function Round90CenterToCenterWprCalculator({ title, image }) {
  ...
  }, [materialId, holeDiameter, widthPitch, lengthPitch, thickness, sheetWidth, sheetLength, perfWidth, perfLength, cost, holeDiameterUnit, widthPitchUnit, lengthPitchUnit, thickUnit, swUnit, slUnit, pwUnit, plUnit]);

  return (
    <CalculatorView title={title} image={image} description="Calculate weight per roll for Round 90° Center to Center holes.">
