...
export default function SquareStaggeredTriangularWprCalculator({ title, image }) {
  ...
  return (
    <CalculatorView title={title} image={image} description="Calculate weight per roll for Square Staggered Triangular holes.">
