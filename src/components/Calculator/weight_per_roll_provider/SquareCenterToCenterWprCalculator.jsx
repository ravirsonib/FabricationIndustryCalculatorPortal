...
import { Square, Activity, Layers, Maximize, IndianRupee } from 'lucide-react';
...
export default function SquareCenterToCenterWprCalculator({ title, image }) {
  ...
  }, [materialId, squareHole, widthPitch, lengthPitch, thickness, sheetWidth, sheetLength, perfWidth, perfLength, cost, squareHoleUnit, widthPitchUnit, lengthPitchUnit, thickUnit, swUnit, slUnit, pwUnit, plUnit]);

  return (
    <CalculatorView title={title} image={image} description="Calculate weight per roll for Square Center to Center / Staggered holes.">
