...
export default function HexagonalStaggeredTriangularWprCalculator({ title, image }) {
  ...
  }, [materialId, hexHole, pitch, thickness, sheetWidth, sheetLength, perfWidth, perfLength, cost, hexUnit, pitchUnit, thickUnit, swUnit, slUnit, pwUnit, plUnit]);

  return (
    <CalculatorView title={title} image={image} description="Calculate weight per roll for Hexagonal Staggered holes.">
