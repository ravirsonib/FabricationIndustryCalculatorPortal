...
export default function Round45StaggeredTriangularWprCalculator({ title, image }) {
  ...
  return (
    <CalculatorView title={title} image={image} description="Calculate weight per roll for Round 45° Staggered Triangular holes.">
