...
export default function CapsuleCenterToCenterWprCalculator({ title, image }) {
  ...
  const handleClear = () => { /* Reset all states to '' */ };

  return (
    <CalculatorView title={title} image={image} description="Calculate weight per roll for Capsule Center to Center / Staggered holes.">
