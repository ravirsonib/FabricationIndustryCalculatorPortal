...
export default function CapsuleStaggeredTriangularWprCalculator({ title, image }) {
  ...
  return (
    <CalculatorView title={title} image={image} description="Calculate weight per roll for Capsule Staggered Triangular holes.">
