...
export default function CapsuleStaggeredTriangularCalculator({ title, image }) {
  // Input States
  ...
  return (
    <CalculatorView title={title} image={image} description="Calculate the open area percentage for capsule staggered triangular holes.">
