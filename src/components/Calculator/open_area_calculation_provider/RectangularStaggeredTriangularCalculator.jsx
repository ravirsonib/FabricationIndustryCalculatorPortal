...
export default function RectangularStaggeredTriangularCalculator({ title, image }) {
  // Input States
  ...
  return (
    <CalculatorView title={title} image={image} description="Calculate the open area percentage for rectangular staggered triangular holes.">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
        <CustomInput label="Width Hole" value={widthHole} onChange={setWidthHole} placeholder="e.g. 10" icon={Maximize} unitOptions={COMMON_UNITS} selectedUnit={widthHoleUnit} onUnitChange={setWidthHoleUnit} />
        <CustomInput label="Length Hole" value={lengthHole} onChange={setLengthHole} placeholder="e.g. 20" icon={Maximize} unitOptions={COMMON_UNITS} selectedUnit={lengthHoleUnit} onUnitChange={setLengthHoleUnit} />
        <CustomInput label="Width Pitch" value={widthPitch} onChange={setWidthPitch} placeholder="e.g. 15" icon={Activity} unitOptions={COMMON_UNITS} selectedUnit={widthPitchUnit} onUnitChange={setWidthPitchUnit} />
        <CustomInput label="Length Pitch" value={lengthPitch} onChange={setLengthPitch} placeholder="e.g. 25" icon={Activity} unitOptions={COMMON_UNITS} selectedUnit={lengthPitchUnit} onUnitChange={setLengthPitchUnit} />
      </div>
