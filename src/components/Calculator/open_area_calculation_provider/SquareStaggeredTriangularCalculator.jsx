...
export default function SquareStaggeredTriangularCalculator({ title, image }) {
  // Input States[cite: 9]
  ...
  return (
    <CalculatorView title={title} image={image} description="Calculate the open area percentage for Square Staggered Triangular holes.">
