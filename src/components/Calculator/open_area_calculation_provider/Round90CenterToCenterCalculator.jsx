...
export default function Round90CenterToCenterCalculator({ title, image }) {
  // Input States
  ...
  useEffect(() => {
    ...
    if (diaMm > 0 && wPitchMm > 0 && lPitchMm > 0) {
  ...
  }, [holeDiameter, widthPitch, lengthPitch, holeDiameterUnit, widthPitchUnit, lengthPitchUnit]);
  ...
  return (
    <CalculatorView title={title} image={image} description="Calculate the open area percentage for Round 90° Center to Center holes.">
