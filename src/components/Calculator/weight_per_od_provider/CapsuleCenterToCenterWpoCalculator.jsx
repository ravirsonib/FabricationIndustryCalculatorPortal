...
export default function CapsuleCenterToCenterWpoCalculator({ title, image }) {
  ...
  }, [materialId, widthHole, lengthHole, widthPitch, lengthPitch, thickness, outerDiameter, perfDiameter, cost, whUnit, lhUnit, wpUnit, lpUnit, thickUnit, odUnit, pdUnit]);

  const handleClear = () => { /* Reset all */ };

  return (
    <CalculatorView title={title} image={image} description="Calculate weight per OD for Capsule Center to Center / Staggered holes.">
