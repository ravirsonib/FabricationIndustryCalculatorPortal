...
import { Square, Activity, Layers, IndianRupee, Circle } from 'lucide-react';
...
export default function SquareStaggeredTriangularWpoCalculator({ title, image }) {
  ...
  }, [materialId, squareHole, widthPitch, lengthPitch, thickness, outerDiameter, perfDiameter, cost, squareHoleUnit, widthPitchUnit, lengthPitchUnit, thickUnit, odUnit, pdUnit]);
  ...
  return (
    <CalculatorView title={title} image={image} description="Calculate weight per OD for Square Staggered Triangular holes.">
