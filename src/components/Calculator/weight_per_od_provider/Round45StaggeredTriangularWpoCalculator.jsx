...
export default function Round45StaggeredTriangularWpoCalculator({ title, image }) {
  ...
  return (
    <CalculatorView title={title} image={image} description="Calculate weight per OD for Round 45° Staggered Triangular holes.">
