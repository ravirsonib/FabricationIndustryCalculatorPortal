...
export default function Round60StaggeredTriangularWpoCalculator({ title, image }) {
  ...
  }, [materialId, holeDiameter, pitch, thickness, outerDiameter, perfDiameter, cost, holeDiameterUnit, pitchUnit, thickUnit, odUnit, pdUnit]);
  ...
  return (
    <CalculatorView title={title} image={image} description="Calculate weight per OD for Round 60° Staggered Triangular holes.">
