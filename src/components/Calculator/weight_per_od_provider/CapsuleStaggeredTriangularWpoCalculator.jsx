...
export default function CapsuleStaggeredTriangularWpoCalculator({ title, image }) {
  ...
  return (
    <CalculatorView title={title} image={image} description="Calculate weight per OD for Capsule Staggered Triangular holes.">
